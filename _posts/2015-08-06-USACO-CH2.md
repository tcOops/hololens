...
tags:
- 算法竞赛
excerpt: 提交地址： [USACO](http://train.usaco.org/usacogate) 考虑到USACO经常挂掉， 可以在其他的地方进行测试， 比如：[USACO-Copy](http://cqoi.net:2012/problemset.php)。 第二章题目较第一章难度有升级， 但是依然考察的算法比较简单， 不过在编程能力方面要求有加强。
---
