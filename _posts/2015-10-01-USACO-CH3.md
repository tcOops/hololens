...
tags:
- 算法竞赛
excerpt: 提交地址： [USACO](http://train.usaco.org/usacogate) 考虑到USACO经常挂掉， 可以在其他的地方进行测试， 比如：[USACO-Copy](http://cqoi.net:2012/problemset.php)。 第三章的题目开始具有一定的难度， 题目覆盖的范围也越来越广， 需要一定的算法能力与解题技巧。
---
